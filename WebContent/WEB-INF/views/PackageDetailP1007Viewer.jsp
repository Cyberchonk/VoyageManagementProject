...
<body>
   ...
   <div class="intro-container">
      <p class="intro intro-title">${applicationScope.P1007.getCity()} Tour Package</p>
	  <p class="intro intro-detail">Kyoto, once the capital of Japan, is a city on the island of Honshu. It's famous for its numerous Buddhist temples, gardens, imperial palaces, Shinto shrines and traditional wooden houses.</p>
	  <div class="price">$ ${applicationScope.P1007.getPrice()} / Person</div>
	  ...
	  <form action="book" method="POST">
	     <input value="1007" name="pID" style="display:none;">
   ...
   <div class="w3-content w3-display-container" style="height:400px">
     <img class="mySlides" src="resources/img/kyoto-japan.jpg" style="width:100%">
