...
<body>
   ...
   <div class="intro-container">
      <p class="intro intro-title">${applicationScope.P1002.getCity()} Tour Package</p>
	  <p class="intro intro-detail">Sapporo, capital of the mountainous northern Japanese island of Hokkaido, is famous for its beer, skiing and annual Sapporo Snow Festival featuring enormous ice sculptures.</p>
	  <div class="price">$ ${applicationScope.P1002.getPrice()} / Person</div>
	  ...
	  <form action="book" method="POST">
	     <input value="1002" name="pID" style="display:none;">
   ...
   <div class="w3-content w3-display-container" style="height:400px">
     <img class="mySlides" src="resources/img/Sapporo.jpg" style="width:100%">
