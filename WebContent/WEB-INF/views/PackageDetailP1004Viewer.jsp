...
<body>
   ...
   <div class="intro-container">
      <p class="intro intro-title">${applicationScope.P1004.getCity()} Tour Package</p>
	  <p class="intro intro-detail">Osaka is a large port city and commercial center on the Japanese island of Honshu. It's known for its modern architecture, nightlife and hearty street food. </p>
	  <div class="price">$ ${applicationScope.P1004.getPrice()} / Person</div>
	  ...
	  <form action="book" method="POST">
	     <input value="1004" name="pID" style="display:none;">
   ...
   <div class="w3-content w3-display-container" style="height:400px">
     <img class="mySlides" src="resources/img/Osaka.jpg" style="width:100%">
