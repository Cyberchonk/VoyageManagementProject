...
<body>
   ...
   <div class="intro-container">
      <p class="intro intro-title">${applicationScope.P1006.getCity()} Tour Package</p>
	  ...
	  <div class="price">$ ${applicationScope.P1006.getPrice()} / Person</div>
	  ...
	  <form action="book" method="POST">
	     <input value="1006" name="pID" style="display:none;">
