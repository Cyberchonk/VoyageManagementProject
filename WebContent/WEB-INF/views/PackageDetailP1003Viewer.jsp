...
<body>
   ...
   <div class="intro-container">
      <p class="intro intro-title">${applicationScope.P1003.getCity()} Tour Package</p>
	  <p class="intro intro-detail">One of the 47 prefectures of Japan and has been the capital since 1869. The Greater Tokyo Area is the most populous metropolitan area in the world. It is the seat of the Emperor of Japan, the Japanese government and the National Diet</p>
	  <div class="price">$ ${applicationScope.P1003.getPrice()} / Person</div>
	  ...
	  <form action="book" method="POST">
	     <input value="1003" name="pID" style="display:none;">
   ...
   <div class="w3-content w3-display-container" style="height:400px">
     <img class="mySlides" src="resources/img/img_1.jpg" style="width:100%">
