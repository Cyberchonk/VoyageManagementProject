...
<head>
   ...
   <div class="intro-container">
      <p class="intro intro-title">${applicationScope.P1001.getCity()} Tour Package</p>
	  <p class="intro intro-detail">Nagoya is the largest city in the Chubu region of Japan. It is Japan's 4th-largest incorporated city and the third-most-populous urban area. It is located on the Pacific coast on central Honshu</p>
	  <div class="price">$ ${applicationScope.P1001.getPrice()} / Person</div>
	  ...
	  <form action="cancel" method="POST">
	     <input value="1001" name="pID" style="display:none;">
   ...
   <div class="w3-content w3-display-container" style="height:400px">
     <img class="mySlides" src="resources/img/theb_nagoya_mv2.jpg" style="width:100%">
