...
<body>
   ...
   <div class="intro-container">
      <p class="intro intro-title">${applicationScope.P1008.getCity()} Tour Package</p>
	  <p class="intro intro-detail">Mount Fuji, located on Honshu, is the highest volcano in Japan at 3,776.24 m, 2nd-highest peak of an island (volcanic) in Asia, and 7th-highest peak of an island in the world.</p>
	  <div class="price">$ ${applicationScope.P1008.getPrice()} / Person</div>
	  ...
	  <form action="book" method="POST">
	     <input value="1008" name="pID" style="display:none;">
   ...
   <div class="w3-content w3-display-container" style="height:400px">
     <img class="mySlides" src="resources/img/Fujiyama.jpg" style="width:100%">
